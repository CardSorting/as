            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        <x-nav-link :href="route('orders.purchases')" :active="request()->routeIs('orders.purchases')">
                            {{ __('My Purchases') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                <x-responsive-nav-link :href="route('orders.purchases')" :active="request()->routeIs('orders.purchases')">
                    {{ __('My Purchases') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('orders.sales')" :active="request()->routeIs('orders.sales')">
                    {{ __('My Sales') }}
                </x-responsive-nav-link>
            @endauth
        </div>
